...
// ==== QUERY FILTER (Kategori wajib 'Pengabdian') ====
$kategori = "Pengabdian";
        ...
        <section class="section" id="arsip">
            ...
            <div class="arsip-controls mb-5">
                <div class="d-flex gap-2">
                    ...
                    <a href="penelitianAdmin.php" class="btn-filter">Penelitian</a>
                    <a href="pengabdianAdmin.php" class="btn-filter active">Pengabdian</a>
                </div>
