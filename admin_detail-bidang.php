...
<main class="content">
  <div class="content-wrapper">
    ...
    function pathGambar($gambar) {
        ...
        // Jika hanya nama file → tambahkan folder uploads
    ...
    <div class="detail-section">
      ...
      <div class="detail-img">
        <img src="<?= htmlspecialchars(pathGambar($data['gambar'])) ?>"
    ...
    <div class="detail-section reverse">
      <div class="detail-text">
        <h2><?= htmlspecialchars($section2['judul']) ?></h2>
        <p><?= nl2br(htmlspecialchars($section2['deskripsi'])) ?></p>
      </div>
      <div class="detail-img">
        <img src="<?= htmlspecialchars(pathGambar($section2['gambar'])) ?>"
             alt="<?= htmlspecialchars($section2['judul']) ?>">
      </div>
    </div>
    <?php endif; ?>
    ...
    <div class="detail-section">
      <div class="detail-text">
        <h2><?= htmlspecialchars($section3['judul']) ?></h2>
        <p><?= nl2br(htmlspecialchars($section3['deskripsi'])) ?></p>
      </div>
      <div class="detail-img">
        <img src="<?= htmlspecialchars(pathGambar($section3['gambar'])) ?>"
             alt="<?= htmlspecialchars($section3['judul']) ?>">
      </div>
    </div>
    <?php endif; ?>
