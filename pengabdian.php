        ...
        <section class="section" id="arsip">
            ...
            <div class="arsip-controls mb-5">
                <div class="d-flex gap-2">
                    ...
                    <a href="penelitian.php" class="btn-filter">Penelitian</a>
                    <a href="pengabdian.php" class="btn-filter active">Pengabdian</a>
                </div>
            ...
            <div class="pagination">
                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                    <a 
                        ...
                        href="pengabdian.php?page=<?= $i ?>&search=<?= $_GET['search'] ?? '' ?>">
                        <?= $i ?>
                    </a>
                <?php endfor; ?>
            </div>
