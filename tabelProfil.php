...
if (isset($_GET['delete_id'])) {
    ...
    $res = pg_query($conn, "SELECT judul FROM profil WHERE profil_id = $delete_id");
    ...
    <main class="content">
        <div class="top-bar-page">
            ...
            <div class="title-container">
                <div class="title-row">
                    <h1 class="title-page">Profil & Sejarah</h1>
                    <a href="addProfil.php" class="btn-add" data-add>
...
<tr>
    ...
    <td>
        <div class="action-buttons">
            <a href="editProfil.php?id=<?= $row['profil_id'] ?>" class="btn-action btn-edit">
                <i class="fa-solid fa-pen"></i>
            </a>
            <a href="tabelProfil.php?delete_id=<?= $row['profil_id'] ?>" class="btn-action btn-delete">
...
<div class="modal-overlay">
    <div class="modal-box">
        ...
        <form method="POST" action="deleteProfil.php" class="modal-form">
            <input type="hidden" name="id" value="<?= $confirmData['id'] ?>">
            <button type="submit" class="btn btn-delete">Ya, hapus</button>
            <a href="tabelProfil.php" class="btn btn-cancel">Batal</a>
        </form>
    </div>
</div>
<?php endif; ?>
